...
namespace Naruto.Redis.IRedisManage
{
    ...
    public interface IRedisList : IRedisDependency
    {
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        void Add<T>(int dataBase, string key, List<T> value);
        /// <summary>
        /// 取list 集合
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="key"></param>
        List<T> Get<T>(int dataBase, string key, long start = 0, long stop = -1);
        ...
        /// <param name="key"></param>
        /// <param name="value">value值</param>
        long Remove<T>(int dataBase, string key, T value, long count = 0);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        string LeftPop(int dataBase, string key);
        /// <summary>
        /// 往最后推送一个数据
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        long RightPush(int dataBase, string key, string value);
        /// <summary>
        /// 往末尾推送多条数据
        /// </summary>
        /// <param name="key"></param>
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        long RightPush<T>(int dataBase, string key, List<T> value);
        /// <summary>
        /// 往最后推送一个数据
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        long RightPush<T>(int dataBase, string key, T value);
        /// <summary>
        /// 删除并返回存储在key上的列表的第一个元素。
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        T LeftPop<T>(int dataBase, string key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        Task AddAsync<T>(int dataBase, string key, List<T> value);
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="key"></param>
        Task<List<T>> GetAsync<T>(int dataBase, string key, long start = 0, long stop = -1);
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="key"></param>
        Task<List<string>> GetAsync(int dataBase, string key, long start = 0, long stop = -1);
        ...
        /// <param name="key"></param>
        /// <param name="value">value值</param>
        Task<long> RemoveAsync<T>(int dataBase, string key, T value, long count = 0);
        /// <summary>
        /// 获取集合中的数量
        /// </summary>
        /// <param name="key"></param>
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        Task<string> LeftPopAsync(int dataBase, string key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        Task<long> RightPushAsync(int dataBase, string key, string value);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        Task<T> LeftPopAsync<T>(int dataBase, string key);
        /// <summary>
        /// 往最后推送一个数据
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        Task<long> RightPushAsync<T>(int dataBase, string key, T value);
        /// <summary>
        /// 往末尾推送多条数据
        /// </summary>
        /// <param name="key"></param>
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        Task<long> RightPushAsync<T>(int dataBase, string key, List<T> value);
        #endregion
